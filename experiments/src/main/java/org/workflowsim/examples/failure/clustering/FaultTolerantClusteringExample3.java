 ...
 * 使用动态重聚类的历史容错教学示例。
 *
 * <p>它用于说明作业失败后重新组织任务的旧版路径。该示例不是标准研究实验入口，
 * 且不能将模型内故障与恢复时间解释为真实生产系统的测量值。</p>
 *
 * @author Weiwei Chen
...
public class FaultTolerantClusteringExample3 extends FaultTolerantClusteringExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ExampleCliSupport.begin("fault-clustering-dr");
            ...
            throw ExampleCliSupport.failure("fault-clustering-dr", e);
        } finally {
